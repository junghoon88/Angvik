...
{
	//UI
	SOUNDMANAGER->addSound(L"¸Þ´ººê±Ý", L"sound/bgm/main.wav", true, true);
	SOUNDMANAGER->addSound(L"stage1bgm", L"sound/bgm/stage1.wav", true, true);
	SOUNDMANAGER->addSound(L"¸Þ´ºÀÌµ¿", L"sound/UI/¸Þ´ºÀÌµ¿.wav", false, false);
	SOUNDMANAGER->addSound(L"¸Þ´º¼±ÅÃ", L"sound/UI/¸Þ´º¼±ÅÃ.wav", false, false);
}
