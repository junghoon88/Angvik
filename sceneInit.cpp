...
void sceneInit::initImage(void)
{
	...
	IMAGEMANAGER->addImage(DEVICE, L"L흰색칼", L"image/item/흰색칼.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흰색랜스", L"image/item/흰색랜스.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흰색부메랑", L"image/item/흰색부메랑.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흰색지팡이", L"image/item/흰색지팡이.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흰색오일", L"image/item/흰색오일.png");
	IMAGEMANAGER->addImage(DEVICE, L"L블랙칼", L"image/item/블랙칼.png");
	IMAGEMANAGER->addImage(DEVICE, L"L블랙랜스", L"image/item/블랙랜스.png");
	IMAGEMANAGER->addImage(DEVICE, L"L블랙부메랑", L"image/item/블랙부메랑.png");
	IMAGEMANAGER->addImage(DEVICE, L"L블랙지팡이", L"image/item/블랙지팡이.png");
	IMAGEMANAGER->addImage(DEVICE, L"L블랙오일", L"image/item/블랙오일.png");
	IMAGEMANAGER->addImage(DEVICE, L"L골드칼", L"image/item/골드칼.png");
	IMAGEMANAGER->addImage(DEVICE, L"L골드랜스", L"image/item/골드랜스.png");
	IMAGEMANAGER->addImage(DEVICE, L"L골드부메랑", L"image/item/골드부메랑.png");
	IMAGEMANAGER->addImage(DEVICE, L"L골드지팡이", L"image/item/골드지팡이.png");
	IMAGEMANAGER->addImage(DEVICE, L"L골드오일", L"image/item/골드오일.png");
	...
	IMAGEMANAGER->addImage(DEVICE, L"L백갑", L"image/item/백갑.png");
	IMAGEMANAGER->addImage(DEVICE, L"L백투", L"image/item/백투.png");
	IMAGEMANAGER->addImage(DEVICE, L"L백신", L"image/item/백신.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흑갑", L"image/item/흑갑.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흑투", L"image/item/흑투.png");
	IMAGEMANAGER->addImage(DEVICE, L"L흑신", L"image/item/흑신.png");
	IMAGEMANAGER->addImage(DEVICE, L"L황갑", L"image/item/황갑.png");
	IMAGEMANAGER->addImage(DEVICE, L"L황투", L"image/item/황투.png");
	IMAGEMANAGER->addImage(DEVICE, L"L황신", L"image/item/황신.png");
	//알
